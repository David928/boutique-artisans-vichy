    ...
    >
      <div className="relative aspect-square w-full bg-ink/5">
        ...
        {!product.is_available && (
          <span className="absolute left-1.5 top-1.5 rounded-full bg-ink px-2 py-0.5 text-[10px] font-medium text-cream-light">
            Indisponible
          </span>
        )}
      </div>
      <div className="p-2.5">
        ...
        {product.price != null && (
          <p className="mt-0.5 text-xs font-medium text-vichy">
