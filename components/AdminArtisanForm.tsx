...
import { updateArtisanAsAdmin } from "@/app/admin/artisans/actions";
...
export function AdminArtisanForm({ artisan }: { artisan: Artisan }) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      try {
        ...
        await updateArtisanAsAdmin(artisan.id, artisan.slug, formData);
        setSaved(true);
        router.refresh();
      } catch (err) {
        setError(
